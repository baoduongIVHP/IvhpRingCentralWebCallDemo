var configAppKey = 'EB2guOuWQ_WNDUaQeM87IQ';
var configAppSecret = 'J9YRiiqzSOuHMTWqRn2EvAwUxyxKGeTdyRKSfmuQ1hIQ';
//var appName = '...';
//var appVersion = '...';
...
$(function() {
    ...
    function makeLoginForm() {
        ...
        $authForm.find('.panel-body').hide();

        $server.val(localStorage.getItem('webPhoneServer') || SDK.server.sandbox);
        $appKey.val(localStorage.getItem('webPhoneAppKey') || configAppKey);
        $appSecret.val(localStorage.getItem('webPhoneAppSecret') || configAppSecret);
